...
If you’d like to be able to hike swiftly through the Valley, or if you’d like to be able to defend yourself against dangerous predators with a hand weapon, you should choose <span style="color: #c00b0b">Fitness</span> as your high aspect.

If you’d like to be able to easily converse and get along with the people of the Valley, or if you want to form deep connections with the natural world, you should choose <span style="color: #b59e00">Spirit</span> as your high aspect.

If you’d like to be able to adeptly avoid the Valley’s many dangers and easily explore the environment, you should choose <span style="color: #039b28">Awareness</span> as your high aspect.

Lastly, if you’d like to be able to expertly solve a multitude of problems and handle situations which require either great concentration or great insight (or both), you should choose <span style="color: #6282c1">Focus</span> as your high aspect.
...
Beginning with the Lead Ranger, choose an aspect card, and place it in front of you. Then the player to your left does the same. Continue to choose aspect cards in this manner until all players have chosen one. Place the remaining aspect cards back in the box. Your aspect card sits in front of you as you play. It is not shuffled into your deck. *Note: If you are playing solo, we recommend choosing a <span style="color: #c00b0b">Fitness</span> of 2 or higher.*

## 4.

Find the Personality card set and separate them by aspect (<span style="color: #039b28">Awareness</span>, <span style="color: #c00b0b">Fitness</span>, <span style="color: #6282c1">Focus</span>, and <span style="color: #b59e00">Spirit</span>). There should be a total of eight cards for each aspect (two copies each of four unique cards).
...
![Awareness Cards](Pictures/personalities.png "Awareness Cards")
...
Before you build the rest of your deck, we’ll go through a round of play using only your Ranger’s personality cards.
...
Find the A Perfect Day card in the weather card set (the back of the A Perfect Day card is Midday Sun). Place A Perfect Day next to the Ancestor’s Grove location card and add three general tokens to it. Build and shuffle the challenge deck.
...
On the Common Tests card, you’ll find the **Traverse** test. During this round, you can use this test to place <span class="progress"></span> on the Ancestor’s Grove location card. Once there’s enough <span class="progress"></span> on Ancestor’s Grove (4 per Ranger), you’ll be able to travel to Boulder Field.

Now, play one round as described on page 12 of the rulebook until either all Rangers are finished taking turns and each has rested, or one Ranger tries to draw a card or suffer fatigue while having no cards remaining in their Ranger deck.

### READ THE ENTRY CORRESPONDING TO WHICH CONDITION WAS MET:

##### A) A Ranger ran out of cards in their Ranger deck:

During normal play, drawing a card or suffering fatigue when you have no cards remaining in your Ranger deck ends the day. But, since you’re playing with far fewer cards in your deck than normal for this prologue, instead shuffle your discard pile and fatigue stack into your Ranger deck and continue playing with the next Ranger turn.

##### B) All Rangers rested:

You’ve nearly finished your first round! If you are able to travel to Boulder Field, do so now. If you haven’t yet added enough <span class="progress"></span> to the location to travel, you’ll have the opportunity to do so next round. Regardless of your location, we’re going to first take a moment to continue to build your Ranger deck before we move on to the refresh phase and the next round of play.
...
![Background Cards](Pictures/backgrounds.png "Background Cards")
...
Add your newly-chosen background cards to your Ranger deck and shuffle them together. Place your deck facedown again.
...
Before proceeding, search the Valley set for Calypsa, Ranger Mentor, and put her into play within reach of a Ranger of your choice. Don’t read her campaign entry during this prologue, however. Your goal for the round is to clear Calypsa by placing sufficient <span class="progress"></span> tokens on her.

On the Common Tests card, you’ll find the Connect test. Try using this test to place <span class="progress"></span> tokens on Calypsa.

Proceed with the refresh phase and then the next round of play. When you clear Calypsa, or when each Ranger has finished taking turns and has rested (regardless of whether or not you cleared Calypsa), read the following:
...
![Specialty Cards](Pictures/specialties.png "Specialty Cards")
...
Add your newly-chosen specialty cards to your Ranger deck and shuffle them together. Place your deck facedown again.

If you’ve chosen Shaper as your specialty, you may search your deck for a conduit and equip it (normally this is done at the start of the day due to the Setup keyword, but for this prologue, you can do it now).

## 23.

Proceed to the refresh phase and the next round of play.
